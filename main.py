    ...
    def load_cookie_from_file(self):
        try:
            if os.path.exists(COOKIE_FILE):
                ...
                self.session.cookies.set("PHPSESSID=1h4thtp90jvnvflse59mdbqic1")
        except:
            pass
